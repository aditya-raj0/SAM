...
TLDR BY ADI: THIS FILE IS THE COACH/MAIN FILE THAT DOES THE TRAINING OF SAM, THIS IS WHERE ALL THE LOSSES ARE INCORPORATED AND THIS IS WHERE THE TRAINING
			 AND VALIDATION STEPS ARE DEFINED.
